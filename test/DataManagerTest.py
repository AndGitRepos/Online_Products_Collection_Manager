...
class DataManagerTest(unittest.TestCase):
    ...
    def testSaveCollectionAsCsv(self) -> None:
        ...
        with open(os.path.join("CsvTestFolder", self.testCollection.name + ".csv"), "r") as f:
            ...
            self.assertEqual(csvLines[0], "name,price,url,rating,reviews\n")
            self.assertEqual(csvLines[1], "productName,10.0,https://www.test.co.uk/,3.5,\"['review1', 'review2']\"\n")
    ...
    def testSaveCollectionAsJson(self) -> None:
        ...
        with open(os.path.join("JsonTestFolder", self.testCollection.name + ".json"), "r") as f:
            self.assertEqual(f.read(), "{\"name\": \"test\", \"products\": [{\"name\": \"productName\", \"price\": 10.0, \"url\": \"https://www.test.co.uk/\", \"rating\": 3.5, \"reviews\": [\"review1\", \"review2\"]}]}")
